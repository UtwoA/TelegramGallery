...
- Действия с изображением: поворот влево/вправо
- Удаление медиафайла (файл на диске + запись в БД)
- Массовое управление на странице `Все фото` (категория, теги, дата съемки, показ на лендинге, массовое удаление)
